    ...
    render() {
        return (
            <div className="body">
                ...
                <div className="kathiPicture">
                    {/* <img className=""/> image of kathi here */}
                </div>
                    <h2>All about the Author</h2>
                    <p> cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum. 
